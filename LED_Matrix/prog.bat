...
set REL_ELF=C:\Users\Brian\Dropbox\raspberrystem\projects\LEDMatrix\src\LED_Matrix_ATINY48\Release\LED_Matrix_ATINY48.elf
set DBG_ELF="C:\Users\Brian\Dropbox\raspberrystem\projects\LEDMatrix\src\LED_Matrix_ATINY48\Debug\LED_Matrix_ATINY48.elf"
echo ERASING
%PROG% %OPTS% chiperase
echo WRITING FUSES
